import { type ApiInfo } from '@/utils'
...
export const API_INFO_LOGIN: ApiInfo = {
	...
	url: ACTION_LOGIN,
	method: 'post',
	mockUrl: aliasToMockUrl('@/apis/mocks/json/login.json')
}
...
export const API_INFO_MY_INFO: ApiInfo = {
	...
	url: ACTION_MY_INFO,
	method: 'get',
	mockUrl: aliasToMockUrl('@/apis/mocks/json/my-info.json')
}
...
export const API_INFO_MY_MENU: ApiInfo = {
	...
	url: ACTION_MY_MENU,
	method: 'get',
	mockUrl: aliasToMockUrl('@/apis/mocks/json/my-menu.json')
}
