<template>
	<ALayoutSider :class="getSiderClass" v-model:collapsed="collapsed" :trigger="null" collapsible :collapsedWidth="LayoutSiderCollapsedWidth" :width="LayoutSiderWidth">
		<LayoutMenu />
	</ALayoutSider>
</template>
<script lang="ts">
...
const { prefixCls } = useHtmlClass('layout-sideBar')
