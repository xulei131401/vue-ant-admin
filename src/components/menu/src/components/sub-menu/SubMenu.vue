<template>
	...
	<ASubMenu :key="item.identify" v-if="Menu.hasChildren(item)">
		<template #title>
...
import MenuItemContent from '../content/MenuItemContent.vue'
import { subMenuProps } from './subMenuProps'
import { usePrefixCls } from '@/composables/core/useHtml'
import { Menu } from '@/models/menu/menu'
const { prefixCls } = usePrefixCls('basic-sub-menu')
